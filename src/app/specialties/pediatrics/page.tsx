...
export default function PediatricsPage() {
  ...
  const pediatricians = [
    {
      ...
      image: '/doctors/pediatrician1.jpg',
      availableDays: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
      availableTime: '9:00 AM - 5:00 PM',
      description: 'Expert in child health, vaccinations, and developmental milestones'
    },
    {
      id: 2,
      name: 'Dr. Mariam Khan',
      ...
      image: '/doctors/pediatrician2.jpg',
      availableDays: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
      availableTime: '10:00 AM - 6:00 PM',
      description: 'Specialized in newborn care and pediatric emergencies'
    },
    {
      id: 3,
      name: 'Dr. Usman Ahmed',
      ...
      image: '/doctors/pediatrician3.jpg',
      availableDays: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
      availableTime: '8:00 AM - 4:00 PM',
      description: 'Expert in adolescent medicine and chronic pediatric conditions'
    }
  ];

  const filteredDoctors = pediatricians.filter(doctor => {
  ...
  const cities = [...new Set(pediatricians.map(doctor => doctor.city))];
  const experiences = [...new Set(pediatricians.map(doctor => doctor.experience))];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Top Pediatricians in Pakistan
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Expert child health specialists providing comprehensive pediatric care
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-center justify-center px-4 py-3 bg-gray-50 rounded-xl">
              <span className="text-sm text-gray-600">
                {filteredDoctors.length} pediatricians found
              </span>
            </div>
          </div>
        </div>
        ...
        {filteredDoctors.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No pediatricians found</h3>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Our Pediatricians?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Baby className="h-8 w-8 text-blue-600" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">Child-Focused Care</h3>
              <p className="text-gray-600">Specialized in children's unique health needs</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Focus on vaccinations and healthy development</p>
            </div>
