...
export default function NeurologyPage() {
  ...
  const neurologists = [
    {
      ...
      image: '/doctors/neurologist1.jpg',
    ...
    },
    {
      ...
      image: '/doctors/neurologist2.jpg',
      availableDays: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
      availableTime: '10:00 AM - 6:00 PM',
      description: 'Specialized in epilepsy and movement disorders'
    },
    {
      id: 3,
      ...
      image: '/doctors/neurologist3.jpg',
      availableDays: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
      availableTime: '8:00 AM - 4:00 PM',
      description: 'Expert in multiple sclerosis and neuroimmunology'
    }
  ];

  const filteredDoctors = neurologists.filter(doctor => {
  ...
  const cities = [...new Set(neurologists.map(doctor => doctor.city))];
  const experiences = [...new Set(neurologists.map(doctor => doctor.experience))];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Top Neurologists in Pakistan
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Expert brain and nervous system specialists providing comprehensive neurological care
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search neurologists..."
                value={searchTerm}
            ...
            <div className="flex items-center justify-center px-4 py-3 bg-gray-50 rounded-xl">
              <span className="text-sm text-gray-600">
                {filteredDoctors.length} neurologists found
              </span>
            </div>
          </div>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="bg-purple-50 rounded-lg p-3 mb-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-bold text-purple-600">Rs. {doctor.consultationFee}</span>
                  </div>
                </div>
        ...
        {filteredDoctors.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No neurologists found</h3>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Why Choose Our Neurologists?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">Board-certified neurologists with specialized training</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">State-of-the-art neurological testing and imaging</p>
            </div>
